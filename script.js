...
const PROJECTS = [
  {
    ...
    excerpt: 'Thiết lập cấu trúc lưu trữ khoa học trên máy tính cá nhân, thực hiện phân loại dữ liệu học tập và chuẩn hóa quy trình đặt tên tài liệu.',
    objective: 'Tổ chức không gian làm việc số tối ưu và xây dựng quy tắc quản lý dữ liệu cá nhân hệ thống, khoa học nhằm tránh thất lạc thông tin.',
    process: ['Khảo sát và phân loại toàn bộ dữ liệu học tập hiện có theo từng học phần và học kỳ.', 'Thiết lập sơ đồ cây thư mục logic (Folder Tree) phân cấp từ tổng quan đến chi tiết trên máy tính cá nhân.', 'Xây dựng và áp dụng bộ quy tắc đặt tên tệp chuẩn hóa.'],
    deliverables: ['Báo cáo PDF'],
  ...
  },
  {
    ...
    num: '02',
    tag: 'BÀI TẬP 02',
    title: 'Khai thác dữ liệu và đánh giá thông tin',
    subtitle: 'Bài 2 — Thông tin số',
    excerpt: 'Thực hiện truy vấn thông tin học thuật bằng các cú pháp tìm kiếm chuyên sâu trên Internet và tiến hành thẩm định độ tin cậy của các nguồn tài liệu thu thập được.',
    objective: 'Áp dụng thành thạo các toán tử tìm kiếm nâng cao để định vị nguồn học liệu chất lượng và thiết lập bộ tiêu chí đánh giá độ tin cậy của thông tin học thuật.',
    process: ['Xác định Keywords liên quan đến đề tài nghiên cứu học thuật được giao.', 'Sử dụng các toán tử tìm kiếm chuyên sâu (như filetype:, site:, "", AND, OR) trên Google và Google Scholar để lọc tài liệu.', 'Thẩm định nguồn tài liệu thu thập được theo mô hình đánh giá nguồn tin chuẩn.'],
    deliverables: ['Báo cáo PDF'],
  ...
  },
  {
    ...
    excerpt: 'Thực hành xây dựng, thử nghiệm và cải tiến các câu lệnh (Prompt) khi tương tác trực tiếp với các mô hình ngôn ngữ lớn (LLMs).',
    objective: 'Rèn luyện kỹ thuật giao tiếp hiệu quả với mô hình ngôn ngữ lớn (LLMs) nhằm tối ưu hóa chất lượng kết quả đầu ra và nâng cao hiệu suất học tập.',
    process: ['Lựa chọn một nhiệm vụ học tập cụ thể (ví dụ: tóm tắt tài liệu hoặc lên ý tưởng thuyết trình).', 'Thử nghiệm đưa ra câu lệnh (Prompt) cơ bản ban đầu và ghi lại kết quả phản hồi của AI.', 'Áp dụng các kỹ thuật viết prompt chuyên nghiệp như định nghĩa vai trò, cung cấp ngữ cảnh, định dạng đầu ra,...để cải tiến câu lệnh và so sánh, đối chiếu hai kết quả đầu ra.'],
    deliverables: ['Báo cáo PDF'],
  ...
  },
  {
    ...
    excerpt: 'Phối hợp nhóm trên các nền tảng điện toán đám mây để thiết lập kế hoạch, phân chia nhiệm vụ và theo dõi tiến độ dự án trực tuyến.',
    objective: 'Sử dụng thành thạo các công cụ số để quản lý dự án và tối ưu hóa quy trình phối hợp làm việc nhóm trực tuyến trên nền tảng điện toán đám mây.',
    process: ['Họp nhóm để thống nhất đề tài, thiết lập mục tiêu chung và lựa chọn công cụ cộng tác trực tuyến', 'Xây dựng bảng phân công nhiệm vụ, xác định thời hạn hoàn thành và phân quyền truy cập tài liệu cho từng thành viên.', 'Thực hiện đồng chỉnh sửa tài liệu theo thời gian thực và theo dõi tiến độ công việc thông qua các kênh cập nhật trực tuyến của nhóm.'],
    deliverables: ['Báo cáo PDF', 'Video sản phẩm'],
  ...
  },
  {
    ...
    excerpt: 'Ứng dụng các công cụ trí tuệ nhân tạo để thiết kế, tạo sinh hình ảnh và xây dựng văn bản, từ đó hoàn thiện một sản phẩm truyền thông số đồng bộ.',
    objective: 'Sử dụng thành thạo các công cụ thiết kế trực quan như Canva, PowerPoint nâng cao để chuyển hóa các nội dung học thuật phức tạp thành các ấn phẩm truyền thông chuyên nghiệp, bắt mắt và dễ tiếp cận.',
    process: ['Nghiên cứu đề tài, chọn lọc thông tin cốt lõi và xây dựng kịch bản phân cảnh (Storyboard) cho sản phẩm truyền thông.', 'Xác định phong cách thiết kế chủ đạo', 'Thực hiện thiết kế ấn phẩm (slide thuyết trình, infographic hoặc video ngắn) trên nền tảng số, tối ưu hóa các yếu tố đồ họa để truyền tải thông điệp một cách ấn tượng nhất.'],
    deliverables: ['Báo cáo PDF', 'Slide thuyết trình'],
  ...
  },
  {
    ...
    num: '06',
    tag: 'BÀI TẬP 06',
    title: 'An toàn số, liêm chính học thuật và AI có trách nhiệm',
    subtitle: 'Bài 6 — An toàn số',
    excerpt: 'Nghiên cứu và xây dựng bộ nguyên tắc cá nhân về bảo mật thông tin, quy chuẩn trích dẫn tài liệu khoa học và các tiêu chuẩn đạo đức khi tương tác với công nghệ.',
    objective: 'Thiết lập các biện pháp bảo mật danh tính số cá nhân, đồng thời ứng dụng công nghệ và trí tuệ nhân tạo để số hóa, lưu trữ và quảng bá các giá trị văn hóa truyền thống Việt Nam đến cộng đồng.',
    process: ['Đánh giá mức độ an toàn thông tin cá nhân trên môi trường mạng và thực hành cấu hình các lớp bảo mật', 'Nghiên cứu, lựa chọn một chủ đề văn hóa Việt Nam (như di sản, ẩm thực, trang phục truyền thống) và thu thập học liệu số liên quan.', 'Sử dụng các công cụ AI và nền tảng số để thiết kế sản phẩm quảng bá văn hóa mang hơi thở hiện đại như triển lãm ảo, ấn phẩm số hóa hoặc bài viết đa phương tiện, đảm bảo tuân thủ các nguyên tắc an toàn thông tin và bản quyền tác giả.'],
    deliverables: ['Báo cáo PDF', 'Infographic PNG'],
...
-  [Infographic "AI Tools Map" - Infographic\\_AITools.png](#) *(Đang cập nhật)*
...
async function loadProjectDetail(id) {
  ...
  // Hybrid approach: try to fetch dynamically (works on servers/GitHub Pages so edits to .md are instant),
  // but fall back to the inline CONTENT_MAP if fetch fails (e.g. CORS on file:// protocol or offline).
  try {
    ...
    console.warn(`Dynamic fetch failed (e.g. CORS on file:// or 404), falling back to inline CONTENT_MAP:`, error);
